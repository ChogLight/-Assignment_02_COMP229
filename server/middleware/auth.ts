...
const singupFunction = async (
    ...
    passport.use('login', new LocalStrategy(strategyOption, loginFunction));
    passport.use('signup', new LocalStrategy(strategyOption, singupFunction));
